...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'john'
        password = 'secret123'
        user = User.objects.create_user(email='john@doe.com', first_name=first_name, last_name=last_name,  password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    '''
    def setUp(self, data={}):
        self.user = User.objects.create_user(email='john@doe.com', first_name='john', last_name='doe',  password='old_password')
